...
namespace ch.froorider.codeheap.Threading
{
    ...
    public interface IScheduler : IEnumerable<ISchedule>, IDisposable
    {
        ...
        /// <summary>
        /// Gets the <see cref="MT.Common.Timing.Schedule"/> at the specified index.
        /// </summary>
        ...
        /// <summary>
        /// Removes and <see cref="IDisposable.Dispose"/>s all <see cref="ISchedule"/>s from this <see cref="IScheduler"/>.
        /// </summary>
        void Clear();
